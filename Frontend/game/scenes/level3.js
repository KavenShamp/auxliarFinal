...
export class level3 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('hellTile2', './assets/images/level4/hell.png');
        this.load.image('hellPartTile2', './assets/images/level4/hellParticulas.png');


        this.load.image('groundBottom2', './assets/images/level4/hellGround.png');

        this.load.image('groundTop2', './assets/images/level4/hellTop.png');

        this.load.image('spikeBottom2', './assets/images/level4/spikeBottom.png');
        this.load.image('spikeTop2', './assets/images/level4/spikeTop.png');
        ...
        this.load.image('spikeSide2', './assets/images/levels/spikeSide.png');
        ...
        this.load.image('level3', './assets/images/level4/level3.png')
    ...
    create() {
        ...
        this.hellTile2 = this.add.tileSprite(0, 0, 1000, 600, "hellTile2");
        this.hellTile2.setOrigin(0, 0);
        this.hellTile2.setScrollFactor(0);

        this.hellPartTile2 = this.add.tileSprite(0, 0, 1000, 600, "hellPartTile2");
        this.hellPartTile2.setOrigin(0, 0);
        this.hellPartTile2.setScrollFactor(0);
        ...
        this.groundBottom = this.physics.add.sprite(0, 650, 'groundBottom2')
            .setOrigin(0, 1)
            .setImmovable(true);
        this.groundTop = this.physics.add.sprite(0, -50, 'groundTop2')
            .setOrigin(0, 0)
            .setImmovable(true);
        ...
        this.level4 = this.add.sprite(490, 570, 'level3')
    ...
    update() {
        ...
        this.hellTile2.tilePositionX += 0.5;
        this.hellPartTile2.tilePositionX += 4;
    ...
    pause() {
        ...
        this.scene.launch('pause', { previous: "level3" });
    ...
    gameOver() {
        ...
        this.time.addEvent({
            delay: 200,
            callback: () => {
                this.scene.start('gameOver',{previous:"level3"});
            },
            loop: false
        })
    }
